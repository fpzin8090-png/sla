...
local Window = OrionLib:MakeWindow({Name = "FatalX Menu", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "FatalX Menu"})
...
W:AddLabel("[+] FatalX Menu is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "FatalX Menu(Noitification)",
